...
class ProblemSolvingAgent:
    ...
    def addSurroundAStar(self, obstacles, goal_pos, visited, tag, dic, sortedList, cPoint, step):
        ...
        for subPoint in ((cPoint[0] - 1, cPoint[1]), (cPoint[0] + 1, cPoint[1]), (cPoint[0], cPoint[1] - 1), (cPoint[0], cPoint[1] + 1),
                         (cPoint[0] - 1, cPoint[1] - 1), (cPoint[0] + 1,cPoint[1] + 1), (cPoint[0] + 1, cPoint[1] - 1),
                         (cPoint[0] - 1, cPoint[1] + 1)):
            if subPoint in ((cPoint[0] - 1, cPoint[1] - 1), (cPoint[0] + 1, cPoint[1] + 1),
                            (cPoint[0] + 1, cPoint[1] - 1), (cPoint[0] - 1, cPoint[1] + 1)):
                distance = sqrt(2)
            else:
                distance = 1
            if (subPoint not in obstacles) and (subPoint not in tag or step[subPoint] > step[cPoint] + distance):
                sortedList.append(subPoint)
                step[subPoint] = step[cPoint] + distance
            ...
            #     if step.get(subPoint) is None or step[subPoint] > step[cPoint] + distance: 
            #         step[subPoint] = step[cPoint] + distance
            #     sortedList.sort(key=cmp_to_key(cmp))
            #     # tag.append(subPoint)
            #     visited.append(subPoint)
